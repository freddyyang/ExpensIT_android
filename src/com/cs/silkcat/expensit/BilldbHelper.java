...
public class BilldbHelper {
    ...
    public boolean Bills_save(int acctid,int fee,int userid,String date,String time,String text){
    	String sql="";
    	Log.v("expensIT","error detecting");
    	try{
    ...
    public void CreateTable_users() {
    	try{
	        ...
	        db.execSQL("insert into tusers values (null,'Personal Expense')");
	        db.execSQL("insert into tusers values (null,'Family Expense')");
	    }catch(Exception e){
    ...
    public void InitAcctitem() {
    	try{
          ...
          db.execSQL("insert into acctitem values (0,null,'Expense')");
          db.execSQL("insert into acctitem values (3,0,'Bills')");
          db.execSQL("insert into acctitem values (4,0,'Gasoline')");
          db.execSQL("insert into acctitem values (5,0,'Dining Out')");
    ...
    public String getBillsTotal(String date){
	    ...
	    while(!cur.isAfterLast()){
	    	...
	    	s="Monthly Income:"+cur.getFloat(1)+"Expense:"+cur.getFloat(0)+"Net:"+cur.getFloat(2);
	    	cur.moveToNext(); 
	    }
	    return s;
    }
